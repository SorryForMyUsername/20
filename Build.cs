...
namespace _20
{
    ...
    internal class Build
    {
        ...
        /// <summary>
        /// поле Количество жильцов
        /// </summary>
        public int kvo;

        /// <summary>
        /// поле Количество этажей
        /// </summary>
        public int floor;
        ...
        /// <param name="kvo">кол-во жителей</param>
        ...
        /// <summary>
        /// Метод, который выводит информацию о строении и вычисляет площадь на одного жильца
        /// </summary>
